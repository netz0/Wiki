...
class Wiki {
	...
	function __construct($return = FALSE)
	{
		...
		ee()->load->helper('file');
		$this->theme_path = PATH_THIRD_THEMES.'wiki_themes/default/';
		$this->image_url = URL_THIRD_THEMES.'wiki_themes/default/images/';
		$this->theme_url = URL_THIRD_THEMES.'wiki_themes/default/';
		...
		if (ee()->TMPL->fetch_param('theme') !== FALSE && ee()->TMPL->fetch_param('theme') != '' && ee()->TMPL->fetch_param('theme') != 'default')
		{
			...
			if (is_dir(PATH_THIRD_THEMES.'/wiki_themes/'.$theme))
			{
				$this->theme_path = PATH_THIRD_THEMES.'wiki_themes/'.$theme.'/';
				$this->image_url = URL_THIRD_THEMES.'wiki_themes/'.$theme.'/images/';
				$this->theme_url = URL_THIRD_THEMES.'wiki_themes/'.$theme.'/';
			}
			else
			{
